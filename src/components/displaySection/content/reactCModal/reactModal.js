    ...
    return (
        <div>
          ...
          <Lightbox
            ...
            imageTitle= 'Front End Development Libraries Projects @freeCodeCamp'
          />
        )}
      <Modal
        {...props}
      ...
      >
        <Modal.Header>
          ...
          Front End Development Libraries Certfication
          </Modal.Title>
        </Modal.Header>
        <Modal.Body>
        ...
        <ul className='photoposts'>
          ...
          <p>
               In Mar 2021, And to get the certificate for the Front End Development Libraries course..I had to go through one hundred and thirty questions whose goal was to consolidate the important information I had learned about Bootstrap, JQuery, SASS, React and Redux
...
25 + 5 Clock
          ...
          <br/>
          <a href="https://www.freecodecamp.org/certification/mahmoudgawish22/front-end-libraries" target="_blank" className="btn btn-block btn-danger">View Certfication!</a>
          </div>
        </Modal.Body>
        <Modal.Footer>
